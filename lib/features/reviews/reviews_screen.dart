...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        const PageHeader(title: 'Reviews', subtitle: 'What your clients are saying'),
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(DateFormat('d MMM yyyy').format(r.date), style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
                    ])),
                    Row(children: List.generate(5, (i) => Icon(i < r.stars ? Icons.star : Icons.star_border, size: 16, color: AppColors.gold))),
                  ]),
                  const SizedBox(height: 12),
                  Text(r.text, style: TextStyle(color: AppColors.textSecondary, height: 1.5)),
                  if (r.reply != null) ...[
                    const SizedBox(height: 12),
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('Your reply', style: TextStyle(color: AppColors.gold, fontSize: 11.5, fontWeight: FontWeight.w700)),
                        const SizedBox(height: 4),
                        Text(r.reply!, style: TextStyle(color: AppColors.textSecondary, fontSize: 13, height: 1.4)),
                      ]),
                    ),
                  ] else ...[
                    const SizedBox(height: 12),
